 ...
 *
 * NOTE: These methods assume you are running on a simulator, not a device. 
 */
@interface XCTestCase (DNSiOSLocalization)

/**
 * Checks to make sure the sim is running in the language you've passed in using the build scheme.
 *
 ...
 *
 * @param developerLanguageCode - The two-letter code for your language. For example, en for English.
